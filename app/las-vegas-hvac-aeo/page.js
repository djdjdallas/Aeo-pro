...
import { metadata as postMeta, tableOfContents, faqs, sections } from "@/content/local-pages/las-vegas-hvac-aeo.js";

export const metadata = generatePageMetadata({
  title: postMeta.title,
  description: postMeta.description,
  path: "/las-vegas-hvac-aeo",
...
export default function Page() {
  const jsonLd = [
    ...
    generateLocalBusinessJsonLd({
      name: "First Answer — HVAC AEO Services",
      description: postMeta.description,
      url: "/las-vegas-hvac-aeo",
