...
import { metadata as postMeta, tableOfContents, faqs, sections } from "@/content/local-pages/las-vegas-roofing-aeo.js";

export const metadata = generatePageMetadata({
  title: postMeta.title,
  description: postMeta.description,
  path: "/las-vegas-roofing-aeo",
...
export default function Page() {
  const jsonLd = [
    ...
    generateLocalBusinessJsonLd({
      name: "First Answer — Roofing AEO Services",
      description: postMeta.description,
      url: "/las-vegas-roofing-aeo",
